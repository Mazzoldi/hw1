                ...
                <ul class="bets">
                    <div class="list"><?php
                        /* if(!empty($favourites)){
                            ...
                            asort($teams);
                            foreach($teams as $team){
                                echo "<li><img src='".$team['logo_filepath']."'>".$team['name']."</li>";
                            }
                            echo "</div>";
                        } */
                    ?>
                    </div>
                    <p id='noresults' <?php /* if(!empty($favourites)){echo "class='hidden'";} */?>>Non hai ancora aggiunto nessuna scommessa</p>
                </ul>
            </div>
        </section>
        <footer>
