<?php
    ...
    $query = "INSERT INTO teams(id, name, short_name, logo_filepath, competition_code, competition_name) VALUES ('$id', '$name', '$short_name', '$logo_file_path', '$competition_code', '$competition_name')";
