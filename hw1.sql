...
--
-- Host: localhost
-- Creato il: Mag 29, 2023 alle 18:56
...
CREATE TABLE `bets` (
  ...
  `away_id` int(8) NOT NULL,
  `stake` decimal(10,0) NOT NULL,
  `bet` varchar(3) NOT NULL,
...
--
ALTER TABLE `bets`
  MODIFY `bet_id` int(9) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT per la tabella `favourites`
--
ALTER TABLE `favourites`
  MODIFY `id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000143;

--
-- AUTO_INCREMENT per la tabella `users`
--
ALTER TABLE `users`
  MODIFY `user_id` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100000007;
...
ALTER TABLE `bets`
  ...
  ADD CONSTRAINT `bets_ibfk_2` FOREIGN KEY (`home_id`) REFERENCES `teams` (`team_id`),
  ADD CONSTRAINT `bets_ibfk_3` FOREIGN KEY (`away_id`) REFERENCES `teams` (`team_id`);
